...
def load_dekkers():
    ...
    results.append(A_antiD)
    results.append(A_antiTNP)
    results.append(glycan_list)
    results.append(mixtures)
    ...
    results.append(mean_3a)
    results,append(mean_3b)
    ...
    results.append(mean_4a, mean_4b)
